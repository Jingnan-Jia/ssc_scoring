...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--eval_id', help='id used for inference, or continue_train', type=int, default=1405)
    ...
    parser.add_argument('--corse_pred_id', help='cascaded validation', default=193_194_276_277)  # 193_194_276_277
    parser.add_argument('--sampler', choices=(1, 0), help='if customer sampler?', type=int, default=0)
    parser.add_arAAAgument('--sys', choices=(1, 0), help='if synthesis_data?', type=int, default=1)
